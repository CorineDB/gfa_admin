<template>
  <div class="py-4">
    ...
    <!-- BEGIN: Modal Content -->
    <Modal size="modal-xl" backdrop="static" :show="showModal" @hidden="close">
      <ModalBody class="p-10">
        <form @submit.prevent="storeUser">
          ...
          <div class="flex justify-evenly">
              <button class="btn btn-outline-secondary py-3 px-4 w-full my-3 xl:mr-3 align-top" @click="showModal = false">Annuler</button>
          ...
          <tr v-for="(data, index) in resultQuery" :key="index">
            ...
            <td>
              <div class="flex justify-evenly">
                ...
                <TrashIcon @click="supprimer(index, data)" class="w-4 h-4 mr-3" />
              </div>
            </td>
          </tr>
        </tbody>
...
const storeUser = function () {
  if (chargement.value == false) {
    ...
    console.log("formData.contact", formData.contact);
